    ...
    <rn:condition hide_on_pages="utils/help_search">
        <div id="rn_NavigationBar">
            ...
            <!--    <li><rn:widget path="navigation/NavigationTab" label_tab="#rn:msg:SUPPORT_HOME_TAB_HDG#" link="/app/home" pages="home, "/></li>
                ...
                <li><rn:widget path="navigation/NavigationTab" label_tab="#rn:msg:LIVE_HELP_HDG#" link="/app/chat/chat_launch" pages="chat/chat_launch,chat/chat_landing"/></li>
				        <li><rn:widget path="navigation/NavigationTab" label_tab="Energy Efficiency" link="/app/energy/eeidform" /></li>
            -->
				<li><rn:widget path="navigation/NavigationTab" label_tab="#rn:msg:SUPPORT_HOME_TAB_HDG#" link="/app/home" pages="home, "/></li>
                <li><rn:widget path="navigation/NavigationTab" label_tab="#rn:msg:ANSWERS_HDG#" link="/app/answers/list" pages="answers/list, answers/detail"/></li>
                <li><rn:widget path="navigation/NavigationTab" label_tab="Tampering" link="/app/tampering/tamp" pages="tampering/tamp, "/></li>
                <li><rn:widget path="navigation/NavigationTab" label_tab="Cut Seal" link="/app/cutseal/cutseal" pages="cutseal/cutseal, "/></li>
                <li><rn:widget path="navigation/NavigationTab" label_tab="DRG" link="/app/drg/drg" pages="drg/drg, "/></li>	  <!-- Change as needed for addition of DRG -->
          <!--      
                pages="/cutseal/cutseal, "
                link="/app/cutseal/cutseal" pages="/cutseal/cutseal, "
                app/tampering/tamp
			-->	
                <li><rn:widget path="navigation/NavigationTab" label_tab="#rn:msg:MY_STUFF_HDG#" link="/app/account/overview" pages="utils/account_assistance, account/overview, account/profile, account/notif, account/change_password, account/questions/list, account/questions/detail, account/notif/list, utils/login_form, utils/create_account, utils/submit/password_changed, utils/submit/profile_updated"
