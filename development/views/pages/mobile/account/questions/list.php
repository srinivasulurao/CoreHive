...
<section id="rn_PageTitle" class="rn_QuestionList">
    <div id="rn_SearchControls">
        ...
        <form method="post" action="" onsubmit="return false">
            <rn:widget path="search/KeywordText2" label_text="" report_id="159" initial_focus="true"/>
            <rn:widget path="search/SearchButton2" report_id="159" icon_path="images/icons/search.png"/>
        </form>
    </div>
</section>
<section id="rn_PageContent" class="rn_QuestionList">
    <div class="rn_Padding">
        ...
        <rn:widget path="reports/MobileMultiline" report_id="159"/>
