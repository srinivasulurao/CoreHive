<rn:meta title="#rn:php:SEO::getDynamicTitle('incident', getUrlParm('i_id'))#" template="oncor.php" login_required="true" clickstream="incident_view"/>
    ...
    <div class="rn_Padding">
        <rn:condition incident_reopen_deadline_hours="168">
            ...
            <form id="rn_UpdateQuestion" method="post" action="" onsubmit="return false;">
                    ...
                    <!-- Disable the Do You Want A Response field from form display | mwh 03/20/2015 2:16p -->
        ...
        <div id="rn_AdditionalInfo">
            ...
            <rn:widget path="output/DataDisplay" name="incidents.status" label="Status"/>
