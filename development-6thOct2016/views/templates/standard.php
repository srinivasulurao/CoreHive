    ...
    <rn:condition hide_on_pages="utils/help_search">
        <div id="rn_NavigationBar">
            <ul>
				...
				<li><rn:widget path="navigation/NavigationTab2" label_tab="Cut Seal" link="/app/cutseal/cutseal" pages="/cutseal/cutseal, "/></li>
                <li><rn:widget path="navigation/NavigationTab2" label_tab="DRG" link="/app/drg/drg" pages="/drg/drg, "/></li> 
				-->
                <? /* uncomment to show Ask A Question & chat/chat_launch page -- mwh 6/1/2015
