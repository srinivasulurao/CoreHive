<rn:meta title="Cut Seal Incident" template="oncor_tampandcutseal.php" clickstream="incident_confirm"/>

<div id="rn_PageTitle" class="rn_AskQuestion">
    <h1>Cut Seal Incident Submitted</h1>
</div>

<div id="rn_PageContent" class="rn_AskQuestion">
    <div class="rn_Padding">
        <p>
            Cut Seal Incident Reference<b>#<rn:field name="incidents.ref_no" />#rn:url_param_value:refno#</b>
        </p>
        <p>
